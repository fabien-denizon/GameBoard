...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db){
        ...
        String SQL_CREATE_GAME_TABLE = "CREATE TABLE "+ GameBoardContract.GameBoardEntry.TABLE_GAMES+ " ( "
                ...
                + GameBoardContract.GameBoardEntry.COLUMN_NB_PLAYER_MIN+" INTEGER NOT NULL, "
        ...
        String SQL_CREATE_LINK_GAME_TYPE = "CREATE TABLE "+ GameBoardContract.GameBoardEntry.TABLE_LINK_GAME_TYPE+" ( "
                ...
                + "FOREIGN KEY ( "+ GameBoardContract.GameBoardEntry.COLUMN_ID_GAME_TYPE_REF_LGT+" ) REFERENCES "+ GameBoardContract.GameBoardEntry.TABLE_GAME_TYPE+" ( "+ GameBoardContract.GameBoardEntry.COLUMN_ID_GAME_TYPE_REF_LGT+" ));";
